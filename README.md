...
| Главный экран | Карточка фильма | Фото и актёры |
|---------------|------------------|----------------|
| ![Главный экран](screenshots/home_screen.png) | ![Карточка фильма](screenshots/movie_detail.png) | ![Актёры](screenshots/actors_gallery.png) |

> Убедись, что изображения лежат в папке `screenshots` рядом с `README.md`.
